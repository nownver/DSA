...
public class Puzzle8_651617 {
    ...
    public Puzzle8_651617(int[] inputArray) {
    ...
    public void nextMoveWithStack() {
        ...
        while (!dfs.isEmpty()) {
            ...
            // explored.add(new Puzzle8State(sequence.clone()));
            popCount++;
            ...
            if (status == true)
            {
                System.out.println("from isGoal [" + Arrays.toString(sequence) + "] found goal [" + Arrays.toString(sequence) + "] let's terminate the loop");
                break;
            }
        }
    }
